...
namespace Bloggr.Controllers
{
  ...
  public class BlogsController : ControllerBase
  {
    ...
    public BlogsController(BlogsService blogsService, CommentsService commentsService, TagsService tagsService)
    {
    ...
    [HttpGet("{blogId}/tags")]
    public ActionResult<List<BlogTag>> GetTagsByBlogId(int blogId)
    {
      try
      {
        var tags = _tagsService.GetByBlogId(blogId);
        return Ok(tags);
      }
      catch (System.Exception e)
      {
    ...
    [HttpPost("{blogId}/tags")]
    public ActionResult<string> AddBlogTag(int blogId, [FromBody] BlogTag data)
    {
      try
      {
        _blogsService.AddBlogTag(blogId, data);
        return Ok("jobs done");
      }
      catch (System.Exception e)
      {
